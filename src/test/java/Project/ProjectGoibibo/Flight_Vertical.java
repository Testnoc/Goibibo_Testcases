package Project.ProjectGoibibo;
...
public class Flight_Vertical  {
	...
	String airlines_selection = "//div[@id='Air India']//label[contains(@class,'posRel alignItemsCenter padL10 curPointFlt')]";
	
	String book_flight = "//*[@id=\"content\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div/div[1]/div[2]/span/span/input";
	...
	String select_nb = "//div[@id='tab_nb']" , select_bank = "//*[@id=\"selectedBank\"]/option[2]" , payment_button = "//button[contains(@class,'button green large width100 payNowBtn netbankingBtn')]";
  ...
  public void Destination() {
	  ...
	  driver.findElement(By.xpath(destination_station)).sendKeys("Mumbai");
  ...
  public void insurance_selection() {
    ...
    public void Proceed_to_payment() throws InterruptedException {
    	...
    	driver.findElement(By.xpath("//*[@id=\"addonCard\"]/div[1]/div")).click();
